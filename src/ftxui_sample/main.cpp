...
// configuration step. It creates a namespace called `plugin_wizard`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", plugin_wizard::cmake::project_name, plugin_wizard::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", plugin_wizard::cmake::project_version);
      return EXIT_SUCCESS;
    }
